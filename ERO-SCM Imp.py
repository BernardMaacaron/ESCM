...
simTime, clockStep, inputSpikesGen = BrianHF.event_to_spike(eventStream, grid_width, grid_height, dt = 0.01*ms, timeScale = 1.0, samplePercentage=1.0)
...
'''
Syn_Params = {'Num_Neighbours' : 2, 'beta': 1.5, 'Wi': 12.0, 'Wk': -3.0, 'method_Syn': 'rk2'}
